      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return axios__WEBPACK_IMPORTED_MODULE_2___default().get("timeline/all");
                      ...
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          case 0:
                            ...
                            _context2.next = 3;
                            return axios__WEBPACK_IMPORTED_MODULE_2___default().post("timeline/delete/" + id);
        ...
        scopedSlots: _vm._u([
          {
            ...
            fn: function(data) {
              return [
                ...
                _c(
                  "router-link",
                  { attrs: { to: "/admin/timeline/edit/" + data.item.editar } },
                  [
                    _c(
                      "button",
