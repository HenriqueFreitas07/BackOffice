...
/* harmony import */ var _chart_demo_chart_area_demo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../chart/demo/chart-area-demo */ "./resources/js/chart/demo/chart-area-demo.js");
/* harmony import */ var _chart_demo_chart_pie_demo__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../chart/demo/chart-pie-demo */ "./resources/js/chart/demo/chart-pie-demo.js");
/* harmony import */ var _chart_demo_chart_bar_demo__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../chart/demo/chart-bar-demo */ "./resources/js/chart/demo/chart-bar-demo.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      Year: Array.from({
        ...
        return new Date().getFullYear() - 10 + index + 1;
      }),
      selectedYear: 2022
    };
  },
  mounted: function mounted() {
    //chartAreaDemo();
    //chartPieDemo();
    (0,_chart_demo_chart_bar_demo__WEBPACK_IMPORTED_MODULE_4__.default)();
    this.mediaMonths();
  },
  methods: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 12:
                ...
                console.log(_this.$store.state.donations);

                _this.SwitchCanvas();

                (0,_chart_demo_chart_bar_demo__WEBPACK_IMPORTED_MODULE_4__.default)(_this.$store.state.donations);
                _this.months = 14;
                console.log(_this.dataSetChart);

                if (_this.dataSetChart.length == 0) {
                  sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire("Aviso", "Não existe nenhuma, registo dos dados selecionados!", "info");
                }
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_5___default().get("donations/" + month + "/" + _this2.selectedYear);
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 3;
                return _this3.requestMonthDonations(month);
              ...
              case 3:
                ...
                data.forEach(function (el) {
                  ...
                  _this3.dataSetChart.push(JSON.stringify(el.amount));
                ...
                (0,_chart_demo_chart_bar_demo__WEBPACK_IMPORTED_MODULE_4__.default)(_this3.dataSetChart, days);
                _context3.next = 13;
                break;
    ...
    ChangeYearDonations: function ChangeYearDonations() {
      ...
      [
        _c(
          ...
          [
            _c("v-progress-linear", {
              attrs: { color: "lime", indeterminate: "", reverse: "" }
            }),
            _vm._v(" "),
        ...
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _c("h5", { staticClass: "pl-2" }, [_vm._v("Ano")]),
            _vm._v(" "),
            _c("b-form-select", {
              attrs: { options: _vm.Year },
              on: {
                change: function($event) {
                  return _vm.ChangeYearDonations()
                }
              },
              model: {
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c(
      "div",
      { staticClass: "chart-area", attrs: { id: "chart-area" } },
